...
- You need to write the Front-End and Back-End code.
- Please read through the entire challenge before starting.
- You have only one week to finish the challenge. Sooner is better.
...
- You are welcome to use a seed project.
...
- Kudos if you have documentation to run project.
- Kudos if you use Redux.
